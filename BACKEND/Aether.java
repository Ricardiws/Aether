...
public class Aether {
            ...
            if (this.keywords.containsKey(comb)) {
                for (Website wsFound : this.keywords.get(comb)) {
                    if (websitesFound.containsKey(wsFound)) {
                        ...
                        websitesFound.put(wsFound,
                                Math.pow(2, comb.length()) * (0.85 * wsFound.getRank() + 0.15 * wsFound.getVisitors()));
                    }
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        // for (int i=0; i<aether.getIndex().getCount(); i++)
        // System.out.println(aether.getIndex().getWebsites()[i].getUrl()+", ");
        ...
        aether.getSearchResults().getSearchResults()) System.out.println(searchResult
        + ", ");
